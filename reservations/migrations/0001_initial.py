    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.CharField(blank=True, help_text='Room location', max_length=255, null=True)),
                ('capacity', models.IntegerField(help_text='Maximum capacity of the room')),
                ('description', models.TextField(blank=True, help_text='Optional description of the room', null=True)),
            ],
        ),
        migrations.CreateModel(
            name='CustomUser',
            fields=[
                ...
                ('last_login', models.DateTimeField(blank=True, null=True, verbose_name='last profile')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reservations',
